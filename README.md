...
This contains simple Java programs to practice fundamental concepts.
...
- [StringMethods.java](./StringMethods.java) – Demonstrates common string operations such as `length()`, `charAt()`, `indexOf()`, and `lastIndexOf()`. It also covers transformations like `toUpperCase()`, `toLowerCase()`, `trim()`, and `replace()`, as well as checks with `isEmpty()`, `contains()`, and `equals()`. Shows how to manipulate and validate strings in practical scenarios.
...
## References
I learned Java by following [Bro Code’s Java Full Course for free ☕ (2025)](https://www.youtube.com/watch?v=xTtL8E4LzTQ).  
There are many tutorial or educational material out there, I just happened to see this one and decided to all in.